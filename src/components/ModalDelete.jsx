...
export default function ModalDelete({ isOpen, onClose, endpoint, identitasColumn }) {
    ...
    }, [isOpen, endpoint, navigate]); // Tambahkan dependensi yang sesuai

    function handleDelete() {
        axios.delete(endpoint['delete'], {
            headers: {
                'Authorization': 'Bearer ' + localStorage.getItem('token'), // Perbaiki penulisan 'Authorization'
            }
        })
        .then(res => {
            ...
            <div className="relative p-4 w-full max-w-md max-h-full">
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="p-4 md:p-5 text-center">
                        ...
                        <button onClick={() => handleDelete()} type="button" className="text-white bg-red-600 hover:bg-red-800
